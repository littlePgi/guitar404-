		...
		<div class="container">
			<div class="row">
			  ...
			  <div class="col-xs-6 col-md-9" style="height:200px;">
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>${order.money}</td>
							<td>
								<a href="${ctx}/admin/order?act=closed&id=${order.id}" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>发货</a>
				...
				<a href="${ctx}/admin/order?act=list&abt=lists" class="btn btn-success"><i class="fa fa-plus"></i>查看已发货订单</a>
			  </div>
			</div>
		</div>
