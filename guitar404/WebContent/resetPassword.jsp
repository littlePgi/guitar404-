		    ...
		    <div class="container">
		        <div class="row">
		            ...
		            <div class="col-md-6 col-12">
		            	<h3>密码重置</h3>
		            	<form action="resetPassword?act=reset" method="post">
		            		<label>用户名：<input type="text" readonly="readonly" value="${user.username }" name="username" style="border:1px solid gray;width:230px;height:30px;" /></label>
		            		<label>输入新密码：<input type="password" autocomplete="off" name="password" style="border:1px solid gray;width:230px;height:30px;" /></label>
		            		<label>确认新密码：<input type="password" autocomplete="off" name="pword" style="border:1px solid gray;width:230px;height:30px;" /></label><br />
		            		<input type="submit" value="重置" style="border:1px solid gray;width:100px;height:40px;cursor:pointer;" />
		            	</form>
		            </div>
		            <!--Login Form End-->
		        </div> 
