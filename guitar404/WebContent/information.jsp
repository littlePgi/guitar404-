                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-1">
                            ...
                            <ul class="nav flex-column dashboard-list" role="tablist">
                                <li> <a class="nav-link" data-toggle="tab" href="#orders">个人信息</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#stay">我的订单</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#collection">我的收藏</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content dashboard-content">
                                <div id="orders" class="tab-pane fade">
                                    ...
                                    <div class="table-responsive" style="font-size:18px;">
                                        ...
                                        <span>手机号：${user.mobil}</span><br />
                                        <span>注册时间：${user.date}</span>
                                        <p><a href="${ctx}/editPassword.jsp">修改密码</a>|
                                        <a href="resetUser.jsp">修改信息</a></p>
                                    </div>
                                </div>
                                ...
                                <div id="collection" class="tab-pane fade">
                                    ...
                                    <div class="table-responsive" style="font-size:18px;border:1px gray solid;width:230px;height:360px;float:left;margin-right:30px;margin-top:30px;">
                                    	<a href="${ctx}/details?id=${collection.guitat_id}">
                                    	 <img alt="图片走丢了" src="${ctx }/${collection.guitar_image}" style="width:230px;height:280px;">
                                    	</a>
                                    	<div>
                                    		<p>${collection.guitar_name}</p>
                                    		<p style="color:red;">￥${collection.guitar_price}</p>
                                    	</div>
                                    </div>
                                    </c:forEach>
                                </div>
